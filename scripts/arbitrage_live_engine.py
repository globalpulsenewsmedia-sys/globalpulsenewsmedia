...
def main():
    global scan_count, found_opportunities, last_scan_latency
    print("[Engine] Executing Single-Pass CEX Scanner Engine...")
    ...
    try:
        ...
        print(f"[OK] CEX scan completed in {last_scan_latency:.4f}s. Saved to {DATA_FILE}")
        
    except Exception as e:
        print(f"[ERROR] Engine Panic: {e}")
